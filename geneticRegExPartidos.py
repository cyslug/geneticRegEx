# Adapted from chapter 17 of _Genetic Algorithms with Python_, from Clinton Sheppard <fluentcoder@gmail.com>
...
class RegexTests(unittest.TestCase):
    def teste_partidos(self):
        Fitness.UseRegexLength = True
        wanted = {"PMDB", "PT", "PSDB", "PP", "PDT",
                  "PTB", "DEM", "PR", "PSB", "PPS",
                  "PSC", "PRB", "PV", "PSD", "PRTB",
                  "PRP", "PSL", "PMN", "PHS", "PTC",
                  "SD", "PSDC", "PODE", "PSOL", "PROS",
                  "PEN", "PPL", "PMB", "PSTU", "PCB",
                  "AVANTE", "PCDOB", "NOVO", "PCO", "REDE"}
